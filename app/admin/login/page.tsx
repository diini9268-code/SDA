...
export const metadata = createPageMetadata({
  title: "Admin Login",
  description: "Sign in to the protected SDA administration area.",
  path: "/admin/login",
});
...
export default async function AdminLoginPage({ searchParams }: AdminLoginPageProps) {
  ...
  return (
    <main className="grid min-h-svh grid-cols-[minmax(0,1fr)] bg-[#0a294d] text-white lg:grid-cols-2">
      <section className="relative hidden min-h-svh overflow-hidden lg:block" aria-label="SDA administrator portal">
        ...
        <div className="absolute inset-x-0 bottom-0 z-10 p-10 xl:p-16">
          <Link href="/" aria-label="SDA home" className="inline-flex rounded-lg focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#27b3f4]">
          ...
          <p className="mt-4 max-w-md text-[18px] leading-8 text-white/70">Secure access to the Somali Diplomacy Association content management and administration system.</p>
        </div>
      </section>
