...
export const metadata = createPageMetadata({
  title: "Member Login",
  description: "Member access for the SSDU community.",
  path: "/login",
});
  ...
  return (
    <main className="flex min-h-svh items-center justify-center bg-[#f3f7fa] px-5 py-10 text-[#071f3c] sm:px-8 sm:py-14">
      <div className="w-full max-w-[610px] text-center">
        <Link href="/" aria-label="SSDU home" className="inline-flex rounded-lg focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#0874b9]"><BrandLogo compactOnMobile /></Link>
        <h1 className="mt-8 font-serif text-[40px] font-bold leading-tight sm:text-[46px]">Member Login</h1>
        <p className="mt-2 text-[17px] leading-7 text-[#52657c]">Welcome back to your SSDU member portal</p>
