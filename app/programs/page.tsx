...
export const metadata = createPageMetadata({
  title: "Programs",
  description:
    "Explore SSDU public programs, student diplomacy activities, and organizational events.",
  path: "/programs",
});
      ...
      <main className="px-6 py-12 sm:px-10 lg:px-16">
        <section className="mx-auto max-w-5xl space-y-8">
          <PageIntro
            eyebrow="Programs"
            title="SSDU Programs"
            description="Public programs, student diplomacy activities, and organizational events published by SSDU administrators."
          />
